...
class SmartTextureImporterEditor : ScriptedImporterEditor
{
    internal static class Styles
    {
        ...
        {
            EditorGUIUtility.TrTextContent("Texture", "This texture source channel will be packed into the Output texture red channel"),
            EditorGUIUtility.TrTextContent("Texture", "This texture source channel will be packed into the Output texture green channel"),
            EditorGUIUtility.TrTextContent("Texture", "This texture source channel will be packed into the Output texture blue channel"),
            EditorGUIUtility.TrTextContent("Texture", "This texture source channel will be packed into the Output texture alpha channel"),
        };
        ...
        public static readonly GUIContent remapRange = EditorGUIUtility.TrTextContent("Remap", "Remaps the input texture value");
        public static readonly GUIContent useLuminance = EditorGUIUtility.TrTextContent("Use Luminance", "If enabled, outputs the combined rgb luminance value.");
        public static readonly GUIContent channel = EditorGUIUtility.TrTextContent("Input Channel", "Selects the RGBA channel to output, defaults to Red.");
    ...
    public override void OnInspectorGUI()
    {
        ...
        var textureFormat = m_UseExplicitTextureFormat.boolValue ? (TextureFormat) m_TextureFormat.intValue : TextureFormat.RGBA32;
    ...
    void DrawTextureImporterSettings()
    {
        ...
        SerializedProperty textureCompression = m_TexturePlatformSettings.FindPropertyRelative("m_TextureCompression");
        SerializedProperty textureCompressionCrunched = m_TexturePlatformSettings.FindPropertyRelative("m_CrunchedCompression");
        ...
        using (new EditorGUI.IndentLevelScope())
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                using (new EditorGUI.DisabledScope(!explicitFormat))
                {
                    ...
                    int format = EditorGUILayout.EnumPopup("Texture Format", (TextureFormat) m_TextureFormat.intValue).GetHashCode();
